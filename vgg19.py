...
#        self.mlp1 = self.mlp(self.conv1_2,'mlp1',reuse,1,3,self.conv1_2.get_shape()[3],9,1,9,1)        
#        self.mlp2 = self.mlp(self.conv2_2,'mlp2',reuse,1,3,self.conv2_2.get_shape()[3],9,1,9,1)
#        self.mlp3 = self.mlp(self.conv3_4,'mlp3',reuse,1,3,self.conv3_4.get_shape()[3],9,1,9,1)
#        self.mlp4 = self.mlp(self.conv4_4,'mlp4',reuse,1,3,self.conv4_4.get_shape()[3],9,1,9,1)
#        self.mlp5 = self.mlp(self.conv5_4,'mlp5',reuse,1,3,self.conv5_4.get_shape()[3],9,1,9,1)
        self.mlp1 = self.mlp(self.conv1_2,'mlp1',reuse,64,9,1)
        self.mlp2 = self.mlp(self.conv2_2,'mlp2',reuse,128,9,1)
        self.mlp3 = self.mlp(self.conv3_4,'mlp3',reuse,256,9,1)
        self.mlp4 = self.mlp(self.conv4_4,'mlp4',reuse,512,9,1)
        self.mlp5 = self.mlp(self.conv5_4,'mlp5',reuse,512,9,1)
