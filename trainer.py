...
def trainer(final_score_sz, batched_data, image, templates_z, scores, loss, train_step, distance_to_gt, z_crops, x_crops, siamNet, summary):
    """
    ...
    # start a tf session with certain config gpu训练选项
